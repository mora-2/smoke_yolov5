...
def strip_optimizer(f='weights/best_epoch600.pt'):  # from utils.utils import *; strip_optimizer()
...
def create_pretrained(f='weights/best_epoch600.pt', s='weights/pretrained.pt'):  # from utils.utils import *; create_pretrained()
